                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                <div class="flex-grow-1">
                                    <h4 class="fs-16 mb-1">{{ $detail }}, {{ Auth::user()->name }}!</h4>
                                    <p class="text-muted mb-0">Semoga harimu mennyenangkan!</p>
                                </div>
                            </div><!-- end card header -->
                        </div>
                        <!--end col-->
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Terakhir Login</h4>
                                </div><!-- end card header -->
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{ asset('admin/themesbrand.com/adhy/html/default/assets/images/users') }}/{{ $u->avatar }}"
                                                                    alt="" class="avatar-xs rounded-circle" />
                                                            </div>
                                                            <div class="flex-grow-1">{{ $u->name }}</div>
                                                        </div>
                                                    </td>
                                                    <td>{{ $u->email }}</td>
                    ...
                    <div class="card h-100 rounded-0">
                        <div class="card-body p-0">
                                ...
                                <div class="acitivity-timeline acitivity-main">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                <a href="apps-ecommerce-product-details.html"
                                                    ...
                                                    <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/products/img-8.png"
                                                        alt="" class="img-fluid d-block" />
                                                </a>
                                                <a href="apps-ecommerce-product-details.html"
                                                    class="bg-light rounded p-1">
                                                    <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/products/img-2.png"
                                                        alt="" class="img-fluid d-block" />
                                                </a>
                                                <a href="apps-ecommerce-product-details.html"
                                                    class="bg-light rounded p-1">
                                                    <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/products/img-10.png"
                                                        alt="" class="img-fluid d-block" />
                                                </a>
                                            </div>
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/users/avatar-2.jpg"
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-notifi1 ms-3">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 avatar-sm">
                                                            <div class="avatar-title bg-light rounded">
                                                                <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/companies/img-1.png"
                                                                    alt="" height="30">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/users/avatar-3.jpg"
                                            ...
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-shrink-0 avatar-sm">
                                                            <div class="avatar-title bg-light rounded">
                                                                <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/companies/img-8.png"
                                                                    alt="" height="30">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                                <div class="card-body">
                                    <img src="{{ asset('admin/themesbrand.com/adhy/html/default') }}/assets/images/giftbox.png"
                                        alt="">
                                    <div class="mt-4">
